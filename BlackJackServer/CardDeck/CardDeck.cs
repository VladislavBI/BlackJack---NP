...
namespace BlackJackServer.CardDeck
{
    /// <summary>
    ...
    public class GeneralDeck: CardDeck
    {
        ...
        /// <summary>
        /// Создать  класс с основной информацией по карте
        /// </summary>
        ...
        /// <summary>
        /// Возвращает класс с основной информацией по карте
        /// </summary>
        /// <returns>Основная информация по карте</returns>
        public ShortCard GetShortCard()
        {
            return CreateShortCard(GetCard());
        }
    }
